...
def credit_card_number(rnd, prefixList, length):
    ...
    return str(completed_number(ccnumber, length))[:-2]
...
# visa16 = credit_card_number(generator, visaPrefixList, 16)
# print(output("VISA 16 digit", visa16))

# visa13 = credit_card_number(generator, visaPrefixList, 13)
# print(output("VISA 13 digit", visa13))

# amex = credit_card_number(generator, amexPrefixList, 15)
...
# diners = credit_card_number(generator, dinersPrefixList, 14)
# print(output("Diners Club / Carte Blanche", diners))

# enRoute = credit_card_number(generator, enRoutePrefixList, 15)
# print(output("enRoute", enRoute))

# jcb = credit_card_number(generator, jcbPrefixList, 16)
# print(output("JCB", jcb))

# voyager = credit_card_number(generator, voyagerPrefixList, 15)
